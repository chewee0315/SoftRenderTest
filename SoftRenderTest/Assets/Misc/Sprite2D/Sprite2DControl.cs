...
public class Sprite2DControl : MonoBehaviour {
	...
	public Sprite2DRoot	root;
	protected Math.Vector2i		div_count = new Math.Vector2i(2, 2);
	...
	{
		return(this.transform.localScale.xy());
	}
	...
	// メッシュの頂点数をゲットする.
	public Math.Vector2i		getDivCount()
	{
	...
	{
		this.transform.parent = this.root.getRootSprite().transform;
		this.position = this.transform.localPosition;
	}
	...
	public void	internalSetDivCount(Math.Vector2i div_count)
	{
